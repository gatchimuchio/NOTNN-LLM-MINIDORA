...
def main(argv=None):
    ...
    if args.契約:
        ...
        print(_符号化({
            ...
            '例': ['命題資料「例」を登録：P。PならばQ。', '資料「例」から「Q」を判定して', '短く説明して', '本文資料「文」を登録：太郎は猫です。詳細は図を参照。', '資料「文」を要約して'],
            '対応範囲': '登録資料上の有限命題・候補仮説・明示ブール介入・未解釈を保持する本文読解。部分読解は全文判定の代替ではなく、任意自然言語や一般常識の理解を意味しない',
