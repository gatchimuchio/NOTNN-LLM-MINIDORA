...
_公開経路 = {
    ...
    'HDSCompiler成果': ('HDS構文化器_records', 'HDSCompiler成果'),
    'HDSIR': ('HDS中間表現', 'HDSIR'),
    ...
    'HDSコンパイラパイプライン版': ('HDS構文化器_pipeline_v1_4', 'HDSコンパイラパイプライン版'),
    ...
    'HDS作用差分構造': ('HDS構文化器_records_v1_3', 'HDS作用差分構造'),
    'HDS作用差分構造生成': ('HDS構文化器_action_delta', 'HDS作用差分構造生成'),
    'HDS作用種別': ('hds統合判断主体', 'HDS作用種別'),
    'HDS作用要求': ('hds統合判断主体', 'HDS作用要求'),
    'HDS作用記録': ('HDS構文化器_records_v1_3', 'HDS作用記録'),
    'HDS保持契約': ('HDS構文化器_records', 'HDS保持契約'),
    ...
    'HDS原理探索要求': ('HDS構文化器_records', 'HDS原理探索要求'),
    'HDS原理段階': ('HDS構文化器_records', 'HDS原理段階'),
    'HDS参照予算': ('HDS参照', 'HDS参照予算'),
    'HDS参照予算選択': ('HDS参照', 'HDS参照予算選択'),
    'HDS参照問合せ候補': ('HDS参照', 'HDS参照問合せ候補'),
    'HDS参照検索': ('HDS参照', 'HDS参照検索'),
    'HDS失敗署名Bank': ('HDS構文化器_failure_bank', 'HDS失敗署名Bank'),
    ...
    'HDS座標': ('HDS中間表現', 'HDS座標'),
    'HDS後続利用記録': ('HDS構文化器_records_v1_3', 'HDS後続利用記録'),
    'HDS意味IR化': ('HDS構文化器_pipeline_v1_4', 'HDS意味IR化'),
    'HDS意味作用': ('HDS中間表現', 'HDS意味作用'),
    'HDS意味専用計画器': ('HDS構文化器_pipeline_v1_4', 'HDS意味専用計画器'),
