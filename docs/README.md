...
3. [`../評価/README.md`](../評価/README.md) — 実測と評価系列
4. [`../設計/README.md`](../設計/README.md) — 現行設計正本と詳細読み順
5. [`../REFERENCES.md`](../REFERENCES.md) — 上位正本・参照commit・責任関係
...
英語版は国際公開用の翻訳であり、意味上の並列正本ではありません。公開入口の英語版は [`../README.en.md`](../README.en.md)。
