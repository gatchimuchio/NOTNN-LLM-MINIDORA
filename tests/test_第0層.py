...
from minidora import Layer0, 計算実行器, 作用, 命令, 手順


class 計算実行器試験(unittest.TestCase):
    def test_Layer0旧名は計算実行器互換alias(self):
        self.assertIs(Layer0, 計算実行器)
