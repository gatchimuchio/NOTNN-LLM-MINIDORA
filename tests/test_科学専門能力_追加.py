...
class 追加科学専門能力健全性試験(unittest.TestCase):
    ...
    def test_LaTeX指数付き光子対生成閾値(self):
        ...
        self.解決器を確認(q, ('3.0e4 GeV', '1.31e5 GeV', '8.0e5 GeV', '1.0e3 GeV'), 1)
    ...
    def test_EDTA綴り揺れでも平衡式を解く(self):
        ...
        self.解決器を確認(q, ('8e-2 M', '6.3e-7 M', '4e-4 M', '2e-9 M'), 1)
    ...
    def test_波動関数の未知係数名に依存しない(self):
        ...
        self.解決器を確認(q, ('0.42', '1.205', '2.2', '5.0'), 1)
    ...
    def test_LaTeX寿命表記から空間分解能を計算(self):
        ...
        self.解決器を確認(q, ('2.78e-6 m', '2.78e-3 m', '2.78e-9 m', '2.78e-1 m'), 0)
    ...
    def test_ブラックホール角径からエントロピー桁を求める(self):
        ...
        self.解決器を確認(q, ('10^58 J/K', '10^63 J/K', '10^68 J/K', '10^71 J/K'), 1)
    ...
    def test_同期サイクロトロンの添字波括弧を許容(self):
        ...
        self.解決器を確認(q, ('2000', '3000', '4000', '8000'), 2)
    ...
    def test_相対論的核分裂補正を一般式で計算(self):
        ...
        self.解決器を確認(q, ('5 MeV', '50 MeV', '500 MeV', '2 MeV'), 1)
    ...
    def test_Pauliハミルトニアンは余分なhbar係数を除く(self):
        ...
        self.解決器を確認(q, ('+epsilon,-epsilon', '+epsilon*hbar/2,-epsilon*hbar/2', '+hbar/2,-hbar/2', '+1,-1'), 0)
    ...
    def test_菱面体111面間隔を数値計算(self):
        ...
        self.解決器を確認(q, ('7.1 Angstrom', '9.80 Angstrom', '12.0 Angstrom', '4.9 Angstrom'), 1)
    ...
    def test_導体外部場は大文字Lを保持(self):
        ...
        self.解決器を確認(q, ('E=kq/l^2', 'E=kq/L^2', 'E=kq/(l-s)^2', 'E=0'), 1)
