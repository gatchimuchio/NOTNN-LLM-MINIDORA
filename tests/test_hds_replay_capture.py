...
class HDSReplay収録試験(unittest.TestCase):
    def test_goldをCompiler検索へ渡さずIR_bundleへ固定する(self) -> None:
        compiler = _Compiler()
        ...
        self.assertNotIn("A", [call for call in compiler.calls if call not in {"engine", "stone"}])
        ...
        self.assertEqual(row["data"][0]["provenance"], ["fixture", "fixture://doc1", "doc:1"])
