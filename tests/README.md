...
`tests/` はMINIDORA模型核・計算実行器・HDS境界・主体主幹・K/J経路の単体試験、negative control、回帰試験を保持する。
...
v0.3プロトタイプ完成の固定判定は `../評価/PROTOTYPE_COMPLETION_2026-08-22.md` を参照する。v0.4の大規模性は別評価として追加する。
